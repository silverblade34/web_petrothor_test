...
<head>
    ...
    <link rel="stylesheet" href="../public/plugins/bootstrap-datepicker/css/bootstrap-datepicker.min.css">
...
<body class="theme-indigo">
    ...
    <div class="page-loader-wrapper" style="display: none;background:none;z-index:999;" id="loader-processs">
        <div class="loader">
            <div class="preloader">
                <div class="spinner-layer pl-red">
                    <div class="circle-clipper left">
                ...
                <ul class="list">
                    ...
                    <li class="active">
                        ...
                        <ul class="ml-menu">
							...
							<li class="active">
								<a href="javascript:void(0);">Registro de precio</a>
							</li>
                            <li>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2 style="display:inline-block;">REGISTROS DE PRECIOS DE LOS CLIENTES</h2>
                <button type="button" class="btn bg-green waves-effect right" style="display:inline-block;" data-toggle="modal" data-target="#aumentoPrecio" onclick="datosNuevoIncremento()">Actualizar precio</button>
            </div>
            <div class="card">
            <div class="body" style="display: flex; justify-content:space-evenly; position:relative; top:10px">
                <div style="width:20%;">
                    ...
                    <select class="form-control show-tick" name="listaprecioSelect" id="listaprecioSelect">
                    ...
                    <div style="width:20%;">
                        ...
                        <div class='datetimepicker input-group date form-line'>
             ...
             <!--<div class="input-daterange input-group">
                                <div class="form-line">
                                    ...
                                    <input type="text" id="fechaSelect" class="datetimepicker form-control" placeholder="...">
        ...
        <div class="modal fade" id="aumentoPrecio" tabindex="-1" role="dialog" style="margin-top:30px;">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <select class="form-control show-tick" name="productoSelect" id="productoSelect">
                                        <option value="0">No seleccionado</option>
                                    </select>
                                ...
                                <div class="encajarCampo col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <p>
                                            <b>Incremento</b>
                                        </p>
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="number" step="0.01" class="form-control" id="incrementoSelect" placeholder="S/.0.00" />
                                            </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="position: relative; top:20px;">
                                    <button type="button" class="btn bg-green btn-block waves-effect" id="datos" onclick="aumentarPrecio()">OK</button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script src="../public/js/myjs/cliente_precio.js"></script>
    <!-- Bootstrap Core Js -->
