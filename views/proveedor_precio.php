...
<body class="theme-indigo">
                ...
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
								<a href="envio_correspondiente.php">Envío correspondiente</a>
							</li>
                            <li>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2 style="display:inline-block;">REGISTROS DE PRECIO</h2>
                <button type="button" class="btn bg-green waves-effect right" style="display:inline-block;" data-toggle="modal" data-target="#nuevoProveedorPrecio" onclick="datosNuevoRegistro()">NUEVO REGISTRO</button>
            </div>
            <div class="card">
        ...
        <div class="modal fade" id="nuevoProveedorPrecio" tabindex="-1" role="dialog" style="margin-top:30px;">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <select class="form-control show-tick" name="proveedorSelect" id="proveedorSelect">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="position: relative; top:20px;">
                                    <button type="button" class="btn bg-green btn-block waves-effect" id="datos">CREAR</button>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal fade" id="editarProveedorPrecio" tabindex="-1" role="dialog" style="margin-top:30px;">
            <div class="modal-dialog modal-default" role="document">
                <div class="modal-content" id="agregarInstalacion">
                    <div class="card">
                        <div class="header">
                        ...
                        <div class="body">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <select class="form-control show-tick" name="ed_proveedorSelect" id="ed_proveedorSelect">
                                        <option value="0">No seleccionado</option>
                                    </select>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class='datetimepicker input-group date form-line'>
                                        <input type='text' id="ed_fechaSelect" class="form-control" />
                                        <span class="input-group-addon">
                                            <span class="glyphicon glyphicon-calendar"></span>
                                        </span>
                                        </div>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="position: relative; top:20px;">
                                    <button type="button" class="btn bg-green btn-block waves-effect" id="ed_datos">GUARDAR CAMBIOS</button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script src="../public/js/myjs/proveedor_precio.js"></script>
    <!-- Bootstrap Core Js -->
