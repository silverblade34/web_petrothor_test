...
<body class="theme-indigo">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2 style="display:inline-block;">PROVEEDORES</h2>
                <button type="button" class="btn bg-green waves-effect right" style="display:inline-block;" data-toggle="modal" data-target="#nuevoProveedor" onclick="nuevo_obtener_datos()">NUEVO PROVEEDOR</button>
            </div>
            <div class="card">
        ...
        <div class="modal fade" id="nuevoProveedor" tabindex="-1" role="dialog" style="margin-top:30px;">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-6 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" id="rucSelect" placeholder="Introducir código" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <button type="button" class="btn bg-green btn-block waves-effect" onclick="crearProveedor()">CREAR</button>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal fade" id="editarProveedor" tabindex="-1" role="dialog" style="margin-top:30px;">
            <div class="modal-dialog modal-default" role="document">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-6 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" id="ed_rucSelect" placeholder="Introducir código" />
                                        </div>
                                    </div>
                                </div>
    ...
    <script src="../public/js/myjs/proveedor_mantenimiento.js"></script>
    <!-- Bootstrap Core Js -->
