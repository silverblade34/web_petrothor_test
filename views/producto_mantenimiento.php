...
<body class="theme-indigo">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                ...
                <button type="button" class="btn bg-green waves-effect right" style="display:inline-block;" data-toggle="modal" data-target="#nuevoProducto" onclick="nuevo_datos_producto()">NUEVO PRODUCTO</button>
            </div>
            <div class="card">
        ...
        <div class="modal fade" id="nuevoProducto" tabindex="-1" role="dialog" style="margin-top:30px;">
        ...
        <div class="modal fade" id="editarProducto" tabindex="-1" role="dialog" style="margin-top:30px;">
            <div class="modal-dialog modal-default" role="document">
    ...
    <script src="../public/js/myjs/producto_mantenimiento.js"></script>
    <!-- Bootstrap Core Js -->
